...
$(function () {
    ...
    $(".js-add-todo").on("click", function (e) {
        ...
        // リストに追加する(後ろに追加)
        var listItem = '<li class="p-listItem p-todoItem js-list_item" data-text="' + text + '">' + '<i class="far fa-circle c-listIcon p-todoItem__icon js-to-done"></i>' + '<span class="p-listItem__text js-todo_list-text">' + text + "</span>" + '<input type="text" class="js-todo_list-editArea" value="' + text + '">' + '<i class="fas fa-trash-alt c-listIcon p-listItem__trash js-to-delete"></i>' + "</li>";
    ...
    $(document).on("click", ".js-to-done", function () {
        $(this).closest(".js-list_item").addClass("p-doneItem").removeClass("p-todoItem");
        $(this).addClass("fas fa-check-circle p-doneItem__icon js-to-todo").removeClass("far fa-circle p-todoItem__icon js-to-done");
    });

    // todoタスクにする(done→todo)
    $(document).on("click", ".js-to-todo", function () {
        $(this).closest(".js-list_item").addClass("p-todoItem").removeClass("p-doneItem");
        $(this).removeClass("fas fa-check-circle p-doneItem__icon js-to-todo").addClass("far fa-circle p-todoItem__icon js-to-done");
    });
